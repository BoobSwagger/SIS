    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; font-family: 'Inter', sans-serif; }
        ...
        .login-card {
            ...
            width: 100%; max-width: 400px; box-shadow: 0 30px 60px rgba(0, 0, 0, 0.5); text-align: center;
        }
        .logo-circle {
            width: 60px; height: 60px; background: linear-gradient(135deg, rgba(255,255,255,0.4), rgba(255,255,255,0.1));
            border-radius: 50%; border: 1px solid rgba(255,255,255,0.4); display: flex; justify-content: center; align-items: center; margin: 0 auto 20px;
        }
        ...
        .form-group input { 
            width: 100%; padding: 14px 15px; background: rgba(0,0,0,0.3); border: 1px solid rgba(255,255,255,0.1); 
    ...
    <div class="login-card">
        ...
        <form method="POST" action="{{ route('login') }}">
            ...
            <div class="form-group">
                ...
                <input type="text" name="username" required placeholder="e.g. 20260001 or admin">
            </div>
            <div class="form-group">
        ...
        <div class="auth-link">
            New student? <a href="/signup">Activate your account</a>
        </div>
    </div>
</body>
</html>